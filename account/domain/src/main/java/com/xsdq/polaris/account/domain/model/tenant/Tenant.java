...
public class Tenant extends BaseEntity {
	...
	public static Tenant create(TenantId id,
			...
			String logo,
			LocalDateTime createTime) {
		return new Tenant(id, name, description, address, contact, logo, TenantStatus.NORMAL, createTime, createTime);
	}
	...
	public static Tenant reconstitute(TenantId id,
			...
			LocalDateTime createTime,
			LocalDateTime updateTime) {
		return new Tenant(id, name, description, address, contact, logo, status, createTime, updateTime);
	}
}
