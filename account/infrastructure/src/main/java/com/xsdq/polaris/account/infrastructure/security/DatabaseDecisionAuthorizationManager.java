 ...
 */
public class DatabaseDecisionAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {

	private static final Logger log = LoggerFactory.getLogger(DatabaseDecisionAuthorizationManager.class);
