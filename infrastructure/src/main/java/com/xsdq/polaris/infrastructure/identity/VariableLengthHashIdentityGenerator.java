 ...
 */
public class VariableLengthHashIdentityGenerator
    implements VariableLengthIdentityGenerator<String> {
  ...
  public VariableLengthHashIdentityGenerator() {
  ...
  @Override
  public Identity<String> generate() {
