...
public final class Utils {
  ...
  public static ServletRequestAttributes getServletRequestAttributes() {
    ...
    if (attributes == null) {
      throw new PolarisRuntimeException(
          "Unable to retrieve 'ServletRequestAttributes', may not be a servlet web environment.");
    }
    return attributes;
  }
  ...
  public static <T> void writeBizResponse(
      HttpServletResponse response, Response<T> bizResponse, ObjectMapper objectMapper)
      throws IOException {
  ...
  public static boolean isInnerIp(String ip) {
    ...
    if (a == 10) return true;
    else if (a == 192 && b == 168) return true;
    else if (a == 172 && b >= 16 && b <= 31) return true;
    else return false;
  }
}
