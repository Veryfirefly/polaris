...
public class UserController {
  ...
  public UserController(
      MenuService menuService, UserService userService, LoginHistoryService loginHistoryService) {
  ...
  public Response<List<Void>> retrieveLoginHistories(
      RetrieveLoginHistoryVO retrieveLoginHistoryVO) {
