...
class UserDetailsBuilderSerializeTests extends MockServletTestKit implements UserMockDataTestKit {
  ...
  void serializeToJsonPolarisUserDetailsBuilder() throws JsonProcessingException {
    PolarisUserDetails userDetails =
        new PolarisUserDetails.Builder()
    ...
    assertThat(strJson, allOf(startsWith("{"), containsString("@class")));

    PolarisUserDetails deserializeBean =
        polymorphicIdObjectMapper.readValue(strJson, PolarisUserDetails.class);
